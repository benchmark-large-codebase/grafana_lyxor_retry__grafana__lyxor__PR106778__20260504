...
require (
	...
	github.com/dolthub/go-mysql-server v0.20.0 // @grafana/grafana-datasources-core-services
	github.com/dolthub/vitess v0.0.0-20250512224608-8fb9c6ea092c // @grafana/grafana-datasources-core-services
